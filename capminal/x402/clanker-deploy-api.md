...
{% hint style="success" %}
* Clanker tokens deployed via **Capminal x402 API** will be the same [**FEE STRUCTURE**](../product-features/token-deployment/#fee-structure) as when you deploy on Capminal UI or using Captain Dackie on X.
